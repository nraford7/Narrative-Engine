...
|---|---|---|---|
| `prose-craft.md` | `~/Dropbox/Noah_Remote_Shared/claude-brain/skills/prose-craft/SKILL.md` | Adapted body (finite NE substitutions in `scripts/ne-prose-adaptations.json`; header, scope and local refs differ) | 2026-09-23; mechanics block from prose-craft 6272681; NE adaptations unchanged |
